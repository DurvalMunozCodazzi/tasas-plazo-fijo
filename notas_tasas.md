# Notas de tasas de plazo fijo online

Registro histórico de TNA (Tasa Nominal Anual) por banco, para plazos fijos online a 30 días, según el comparador del BCRA (https://www.bcra.gob.ar/plazos-fijos-online/).

> Nota metodológica: en este entorno el acceso directo a bcra.gob.ar y a sitios espejo está bloqueado por el proxy de red (egress). Cuando esto ocurre, los datos se compilan vía búsqueda web a partir de medios que citan el comparador oficial del BCRA, y se indica en la entrada.

---

## Lectura: 2026-08-18 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar bloqueado en este entorno) — medios que citan el comparador oficial BCRA, datos al 17-18/08/2026.
...
## Lectura: 2026-08-20 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar y a los sitios de medios bloqueado por el proxy de egress de este entorno) — medios que citan el comparador oficial BCRA, datos al 20/08/2026.
...
**Comparación con lectura anterior (2026-08-19, máx. 23%):** ⬇️ SIN INCREMENTO. La TNA máxima registrada hoy (22,25%) es menor a la de la lectura anterior. No se emite aviso.

> Salvedad: la entrada del 2026-08-19 registró 23% para Crédito Regional (tasa de clientes) a partir de un único resultado de búsqueda. Las búsquedas de hoy ubican a Crédito Regional y Meridian en 22,25% (clientes) y 22,5% (no clientes), sin confirmar el 23%. Es posible que el 23% de ayer haya sido un dato erróneo o un tope del rango citado por los medios, más que una tasa efectivamente ofrecida.

---

## Lectura: 2026-08-21 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar y a los sitios de medios/comparadores bloqueado por el proxy de egress de este entorno) — medios que citan el comparador oficial BCRA, datos al 21/08/2026.
...
\* No confirmado en las búsquedas de hoy; valor arrastrado de la lectura anterior (2026-08-20).
...
## Lectura: 2026-08-24 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar y a los sitios de medios/comparadores bloqueado por el proxy de egress de este entorno) — medios que citan el comparador oficial BCRA, datos de la tercera/cuarta semana de agosto de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy; valor arrastrado de la lectura anterior (2026-08-23).
...
## Lectura: 2026-08-27 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar y a los sitios de medios/comparadores bloqueado por el proxy de egress de este entorno) — múltiples medios y comparadores (indicadores.ar, mdzol.com, iproup.com, eldestapeweb.com, entre otros), datos del 26-27 de agosto de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy; valor arrastrado de la lectura anterior (2026-08-26). Banco BICA y Banco CMF tuvieron menciones dispersas hoy (BICA: 22%/23% según fuente; CMF: 22%/22,50% según fuente) que no permiten actualizar el valor con confianza, por lo que se mantiene el dato previo.
...
## Lectura: 2026-08-30 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar y a los sitios de medios/comparadores —mdzol.com, eleconomista.com.ar, indicadores.ar— bloqueado por el proxy de egress de este entorno) — múltiples medios (mdzol, El Destape) que citan el comparador oficial BCRA, datos de la última semana de agosto de 2026.

| Banco | TNA |
|---|---|
| Bibank | 24%* |
| Reba Compañía Financiera S.A. | 24% |
| Crédito Regional Compañía Financiera S.A. (clientes) | 24%* |
| Banco CMF S.A. | 24%* |
| Banco de Comercio | 23,5%* |
| Banco BICA S.A. | 23%* |
| Banco del Sol | 23%* |
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso bloqueado a los sitios con desglose banco por banco); valor arrastrado de la lectura anterior (2026-08-29) o tomado de resúmenes de búsqueda que citan el mismo período ("última semana de agosto 2026"). Búsquedas de hoy citan de forma consistente un máximo de 24% TNA, atribuido en distintos resúmenes a Bibank, Crédito Regional y Reba (una búsqueda) y a Banco CMF y Reba (otra, para el 29/08) — se registra 24% como Reba en ambos casos, y se suman Bibank, Crédito Regional y CMF como no confirmados de forma independiente hoy, dado el solapamiento con el nivel ya confirmado ayer.
...
## Lectura: 2026-09-01 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, indicadores.ar, mundoempresarial.ar, comparatasas.ar, dolarhoy.com, puntobiz.com.ar e infobae.com bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA y notas de prensa (Infobae del 31/08, iProfesional, Dolarhoy), sin datos independientes fechados específicamente hoy 01/09.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los sitios con desglose banco por banco bloqueado por el proxy de egress); valor arrastrado de la lectura anterior (2026-08-31). Las búsquedas de hoy repiten de forma consistente el liderazgo de Banco CMF S.A. y Reba Compañía Financiera S.A. en 24% TNA (Dolarhoy, indicadores.ar vía snippet), sin evidencia de una suba adicional. Una única búsqueda mencionó de forma aislada un 24,25% para Crédito Regional y un 24% para "Banco Masventas" y Banco Voii, pero ese dato no se repitió en ninguna otra búsqueda (que ubican a Crédito Regional en 23-23,5% y a Voii en 21,75-22,75%) ni pudo contrastarse con una segunda fuente independiente, por lo que se descarta como no confirmado, siguiendo el mismo criterio conservador aplicado en lecturas anteriores (ver 2026-08-19, 2026-08-21, 2026-08-24, 2026-08-25).
...
## Lectura: 2026-09-03 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, indicadores.ar, rionegro.com.ar, servidos.ar, equitylens.com.ar, mundoempresarial.ar, comparatasas.ar, diariomendoza.com.ar e iprofesional.com bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA e Indicadores AR, fechados 3 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los sitios con desglose banco por banco bloqueado por el proxy de egress); valor arrastrado de la lectura anterior (2026-09-02). Las búsquedas de hoy confirman a Banco CMF S.A. como líder junto con Reba Compañía Financiera S.A., ambos en 24% TNA (título del comparador Indicadores AR: "Mejor TNA: 24.0% (BANCO CMF S.A.)"; CMF sube respecto al 23,5% de ayer), con Banco BICA S.A. en 23%, Banco Voii S.A. en 22,75%, Banco Nación en 20% y Banco Macro en 19,5% (todos sin cambios respecto a la lectura anterior). Una búsqueda mencionó de forma aislada un 27-28% TNA para Banco Macro, Banco de Córdoba, Banco BICA, Banco CMF y Banco Voii, y un 23,5% para Banco Nación, pero esos valores se contradicen entre sí y con los datos confirmados por múltiples fuentes en las demás búsquedas (Banco Nación 20%, Banco Macro 19,5%, BICA 23%, CMF/Voii en los valores de la tabla), por lo que se descartan como no confirmados / posible error de resumen automático, siguiendo el mismo criterio conservador aplicado en lecturas anteriores.

**TNA máxima del día:** 24% — Banco CMF S.A. / Reba Compañía Financiera S.A. (empate), sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-02, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-04 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, indicadores.ar y servidos.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA, el comparador Indicadores AR (título: "Mejor TNA: 24.0% (BANCO CMF S.A.)") y notas de prensa (Diario Mendoza, BAE Negocios, Diario Río Negro), fechadas 2-4 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los sitios con desglose banco por banco bloqueado por el proxy de egress); valor arrastrado de la lectura anterior (2026-09-03). El resto de los valores de la tabla surge de un resumen de búsqueda que presenta un ranking coherente y consistente internamente (probablemente basado en Diario Mendoza / BAE Negocios), confirmando a Banco CMF S.A. y Reba Compañía Financiera S.A. como líderes en 24% TNA (también corroborado por el título del comparador Indicadores AR), seguidos por Crédito Regional y Banco Meridian en 23,5%, un grupo de Banco BICA, Banco del Sol, Mariva y Voii en 23%, Banco Nación en 20%, Macro y BBVA en 19,5%, Galicia y Credicoop en 18,5%, ICBC en 18,1%, Santander y Ciudad en 17%, y Patagonia en 16%. Estos valores implican pequeñas subas respecto a la lectura anterior para Meridian, Mariva, Voii, BBVA, Galicia, Credicoop e ICBC, pero no alteran la TNA máxima del día (se mantiene en 24%, mismo empate CMF/Reba que ayer).

**TNA máxima del día:** 24% — Banco CMF S.A. / Reba Compañía Financiera S.A. (empate), sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-03, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-05 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, indicadores.ar y rionegro.com.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA, el comparador Indicadores AR (título: "Mejor TNA: 24.0% (BANCO CMF S.A.)") y notas de prensa (Ámbito, Diario Río Negro, Diario Mendoza), fechadas 2-5 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy; valor arrastrado de la lectura anterior (2026-09-04).

\*\* Discrepancia entre fuentes: un resumen de búsqueda ubica a Banco CMF S.A. en 23,5% TNA hoy (empatado con Crédito Regional, con Reba como único líder en 24%), mientras que el título del comparador Indicadores AR sigue mostrando "Mejor TNA: 24.0% (BANCO CMF S.A.)". Ante la duda, se mantiene el valor de 24% para CMF (arrastrado de la lectura anterior) marcado como no confirmado de forma unívoca; en cualquier caso, la TNA máxima del día es 24% (Reba, confirmado por ambas fuentes), por lo que esta discrepancia no altera el resultado de la comparación con la lectura anterior.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A. (posiblemente empatada con Banco CMF S.A., ver nota arriba), sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-04, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-06 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, indicadores.ar, rionegro.com.ar y diariomendoza.com.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA, el comparador Indicadores AR (título: "Mejor TNA: 24.0% (BANCO CMF S.A.)") y notas de prensa (La Nación del 4/09, Diario Río Negro, Diario Mendoza, BAE Negocios), fechadas 2-5 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los sitios con desglose banco por banco bloqueado por el proxy de egress); valor arrastrado de la lectura anterior (2026-09-05). Las búsquedas de hoy confirman a Reba Compañía Financiera S.A. y Banco CMF S.A. liderando en 24% TNA, con Banco BICA S.A., Banco del Sol y Banco Voii S.A. en 23% (Voii sube levemente respecto al 22,75% previo), y Banco Nación (20%), Banco Macro y BBVA (19,5%) y Banco Galicia (18,5%) sin cambios.
...
## Lectura: 2026-09-08 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, indicadores.ar, ambito.com, infobae.com, comparatasas.ar, servidos.ar, todoprops.com y reba.com.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA y notas de prensa (Ámbito, Infobae, MDZ, indicadores.ar), fechadas 2-8 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los sitios con desglose banco por banco bloqueado por el proxy de egress); valor arrastrado de la lectura anterior (2026-09-07) o tomado de resúmenes de búsqueda que citan el mismo período. Las búsquedas de hoy confirman a Banco CMF S.A. subiendo a 24% TNA (desde 23,5% el día anterior), empatando con Reba Compañía Financiera S.A. en el liderazgo; indicadores.ar (vía resumen de búsqueda) cita "Mejor TNA: 24,0% (Banco CMF S.A.)" como la tasa más alta relevada hoy. Sin evidencia de ninguna entidad por encima de 24%.
...
## Lectura: 2026-09-10 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, canal26.com, rionegro.com.ar, ar.headtopics.com y derechadiario.com.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA y notas de prensa (Ámbito, La Nación, El Cronista, Diario Mendoza, MDZ), fechadas 8-10 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los sitios con desglose banco por banco bloqueado por el proxy de egress); valor arrastrado de la lectura anterior o tomado de resúmenes de búsqueda que citan el mismo período. Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA (fuentes fechadas 9-10/9: La Nación, Ámbito, El Cronista); Banco CMF aparece citado en 23,5% en las notas más recientes (9-10/9), tras haber sido reportado en 24% el 8-9/9 — posible fluctuación menor o discrepancia entre fuentes, sin impacto en el máximo del mercado. Sin evidencia de ninguna entidad por encima de 24%; los bancos tradicionales (Nación, Provincia, BBVA, Macro) se mantienen sin cambios en 19,5-20%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A., sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-09, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-11 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, tuplazofijo.com.ar, dolarito.ar, servidos.ar, ambito.com e indicadores.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA e indicadores.ar, y notas de prensa (Ámbito, Río Negro, Canal26, Diario Mendoza, La Posta Diario), fechadas 2-11 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor tomado de resúmenes de búsqueda que citan el mismo período o arrastrado de la lectura anterior. Las búsquedas de hoy confirman a Reba Compañía Financiera S.A. como líder consistente en 24% TNA; el título de la página comparadora de indicadores.ar (vía resumen de búsqueda) cita "Mejor TNA: 24,0% (BANCO CMF S.A.)", lo que sugiere que Banco CMF también alcanzó 24% (aunque otro resumen del mismo día ubica a CMF en 23,5%, empatado con Crédito Regional) — dato ambiguo entre fuentes, sin impacto en el máximo del mercado ya que Reba ya estaba en 24%. Banco Voii y Banco Mariva aparecen hoy citados en 22,75% y 22,5% respectivamente (antes 23%), posible ajuste a la baja. Sin evidencia de ninguna entidad por encima de 24%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A. (posiblemente empatada con Banco CMF S.A., dato ambiguo).

**Comparación con lectura anterior (2026-09-10, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-12 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, equitylens.com.ar, todoprops.com, servidos.ar, rionegro.com.ar y diariomendoza.com.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA e indicadores.ar, y notas de prensa (Ámbito, Diario Río Negro, Diario Mendoza, Canal26, Finect), fechadas 2-12 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor arrastrado de la lectura anterior (2026-09-11). Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA, con Banco CMF S.A. y Crédito Regional en 23,5%, y un grupo de Banco BICA, Banco del Sol, Banco Mariva y Banco Voii en 23% — mismo panorama que la lectura anterior, sin evidencia de ninguna entidad por encima de 24%. Los bancos tradicionales (Nación, Provincia, BBVA, Macro) se mantienen sin cambios en 19,5-20%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A., sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-11, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-13 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, equitylens.com.ar, servidos.ar, ambito.com y lapostadiario.com bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA, y notas de prensa (Ámbito, Canal26, Diario Río Negro, Diario Mendoza, Diario Mendoza, Noticias Argentinas), fechadas 2-13 de septiembre de 2026.

| Banco | TNA |
|---|---|
| Reba Compañía Financiera S.A. | 24% |
| Banco CMF S.A. | 23,5%* (un titular de Ámbito de hoy sugiere 24%, dato ambiguo) |
| Crédito Regional Compañía Financiera S.A. | 23,5%* |
| Banco BICA S.A. | 23%* |
| Banco del Sol | 23%* |
| Banco Mariva | 22,5%* |
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor arrastrado de la lectura anterior (2026-09-12) o tomado de resúmenes de búsqueda del período. Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA; un titular de Ámbito de hoy atribuye la "mejor tasa" a Banco CMF S.A. con 24%, mientras otro resumen del mismo día lo ubica en 23,5% — dato ambiguo entre fuentes, sin impacto en el máximo del mercado ya que Reba ya estaba en 24%. Se observa que Banco Nación bajó de 20% a 19,5% durante el mes (variabilidad reportada por búsquedas de hoy), quedando ahora igualado con Banco Macro y BBVA. Sin evidencia de ninguna entidad por encima de 24%.
...
## Lectura: 2026-09-15 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, indicadores.ar, equitylens.com.ar, eldestapeweb.com bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA e indicadores.ar, y notas de prensa (El Economista, El Destape, Infobae, Canal26, Diario Mendoza, ElDoce.tv, La Posta Diario), fechadas 2-15 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor tomado de resúmenes de búsqueda del período o arrastrado de la lectura anterior (2026-09-14). Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA, seguido por Banco CMF en 23,5% y Banco Meridian en 23,25% (subió desde 22,5% en la lectura anterior). Se observa un movimiento notable en Banco Provincia, que pasó de 19,5% a 21% (clientes) / 22% (no clientes), y Banco Nación bajó de 20% a 18,75%. Sin evidencia de ninguna entidad por encima de 24%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A., sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-14, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-16 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, www2.bcra.gob.ar, equitylens.com.ar, eldestapeweb.com e iproup.com bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA, notas de la "tercera semana de septiembre 2026" (El Destape, Diario Río Negro, Diario Mendoza, ElDoce.tv, El Monterizo, Infobae), fechadas 14-16 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor arrastrado de la lectura anterior (2026-09-15). Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA, seguido por Banco CMF en 23,5%. Se observan leves bajas en Banco Galicia (18,5%→17,75%) y Banco Santander (17%→16,5%). Sin evidencia de ninguna entidad por encima de 24%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A., sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-15, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-17 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, y a comparatasas.ar, iproup.com, servidos.ar, canal26.com, rionegro.com.ar, urgente24.com, mdzol.com, dolarito.ar y lanacion.com.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA, notas de la "tercera semana de septiembre 2026" y del miércoles 16/09 (El Destape, La Nación, Diario Río Negro, Diario Mendoza, Ámbito, Infobae, La Derecha Diario), fechadas 14-17 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor arrastrado de la lectura anterior (2026-09-16). Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA, seguido por Banco CMF en 23,5% y Banco Meridian en 23,25%. Los bancos tradicionales se mantienen prácticamente sin cambios: Banco Provincia 21%/22%, Banco Nación 18,75%, BBVA y Macro 19,5%, Credicoop 18,5%, Galicia 17,75%, Santander 16,5%, Patagonia 16%. Sin evidencia de ninguna entidad por encima de 24%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A., sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-16, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

## Lectura: 2026-09-18 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar, servidos.ar, sinelefantesblancos.com.ar, lanacion.com.ar e iproup.com bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA, nota de La Nación de este jueves 18 de septiembre y otras notas de El Destape, Diario Mendoza, Urgente24, MDZ Online, ON24 e Infobae, fechadas 14-18 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor arrastrado de la lectura anterior (2026-09-17). Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA, seguido por Banco CMF y Crédito Regional en 23,5% y Banco Meridian en 23,25%. Entre los bancos tradicionales, Banco Provincia encabeza con 21% (clientes), y Banco Nación, Banco Macro y BBVA pagan 19,5%. Sin evidencia de ninguna entidad por encima de 24%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A., sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-17, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

## Lectura: 2026-09-19 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar y a servidos.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA y notas de Ámbito, BAE Negocios, La Posta Diario, iProfesional, MDZ Online y El Destape fechadas entre el 1 y el 19 de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor arrastrado de la lectura anterior (2026-09-18). Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA, seguido por Banco CMF y Crédito Regional en 23,5%, y Banco Mariva, Banco del Sol y Banco BICA en 23%. Entre los bancos tradicionales, Banco Nación subió de 19,5% a 20% y pasó a liderar ese grupo, por delante de BBVA y Banco Macro (19,5%). Sin evidencia de ninguna entidad por encima de 24%.

**TNA máxima del día:** 24% — Reba Compañía Financiera S.A., sin cambios respecto a la lectura anterior.

**Comparación con lectura anterior (2026-09-18, máx. 24%):** ➡️ SIN CAMBIOS. La TNA máxima se mantiene igual a la de la lectura anterior. No se emite aviso.

---

## Lectura: 2026-09-20 (UTC)

**Fuente:** búsqueda web (acceso directo a bcra.gob.ar bloqueado por el proxy de egress de este entorno) — resúmenes de búsqueda que citan el comparador oficial BCRA y notas de Ámbito, El Destape, Diario Río Negro, Diario Mendoza, Finect y Urgente24 fechadas en la tercera semana de septiembre de 2026.
...
\* No confirmado de forma independiente en las búsquedas de hoy (acceso directo a bcra.gob.ar y a los comparadores con desglose banco por banco bloqueado por el proxy de egress de este entorno); valor arrastrado de la lectura anterior (2026-09-19). Las búsquedas de hoy confirman de forma consistente a Reba Compañía Financiera S.A. como líder en 24% TNA, seguido por Banco CMF y Crédito Regional en 23,5%, y Banco Mariva, Banco BICA y Banco del Sol en 23%. Entre los bancos tradicionales, Banco Nación aparece en 19,5% en las fuentes de hoy (una nota reciente lo había ubicado en 20%; no se pudo reconfirmar de forma independiente cuál es el valor vigente exacto hoy). Sin evidencia de ninguna entidad por encima de 24%.
